...
//   console.log(' user@gmail.com user123456 /n admin@school.com NewAdmin@123 /n subadmin@cygen.com SubAdmin@123 ');
...
//     } catch (err) {
//       const errMsg = err.response?.data?.message || "Server error. Please try later.";
